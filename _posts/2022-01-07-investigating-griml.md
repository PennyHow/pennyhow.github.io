...
<p style="text-align:justify;">I intend to also have an add-on module to interact with the [SentinelHub APIs](https://sentinelhub-py.readthedocs.io/en/latest/), a cloud processing platform that can be used to retrieve and process data from many satellite products. This should be a fun component of the project, as pushed scripts to the API are advised to be in Javascript -- a programming language I have some experience with, but want to be better at.
