...
[caption id="attachment_1027" align="aligncenter" width="1139"]<img class="alignnone size-full wp-image-1027" src="https://pennyhow.files.wordpress.com/2016/01/tuna_calving_types_plot_02.jpg" alt="Calving events at Tunabreen over a 30-hour period in August 2015, captured using high-resolution time-lapse photography (one photo every three seconds). Calving events are categorised as subaerial (i.e. ice falling from the front above the waterline), subaqueous (i.e. ice breaking off from the front beneath the waterline), both (i.e. large calving events which contain both subaerial and subaqueous originating ice) and unknown (caused by concealment or poor visibility)." width="1139" height="764" /> Calving events at Tunabreen over a 30-hour period in August 2015, captured using high-resolution time-lapse photography (one photo every three seconds). Calving events are categorised as subaerial  (red), subaqueous (blue), both (green) and unknown (black).[/caption]

[caption id="attachment_1028" align="aligncenter" width="1159"]<img class="alignnone size-full wp-image-1028" src="https://pennyhow.files.wordpress.com/2016/01/krone_calving_types_plot_02.jpg" alt="Calving events at Kronebreen over a 60-hour period in September 2015, captured using high-resolution time-lapse photography (one photo every three seconds). Calving events are categorised as subaerial (i.e. ice falling from the front above the waterline), subaqueous (i.e. ice breaking off from the front beneath the waterline), both (i.e. large calving events which contain both subaerial and subaqueous originating ice) and unknown (caused by concealment or poor visibility)." width="1159" height="781" /> Calving events at Kronebreen over a 60-hour period in September 2015, captured using high-resolution time-lapse photography (one photo every three seconds). Calving events are categorised as subaerial (red), subaqueous (blue), both (green) and unknown (black)[/caption]
...
[caption id="attachment_1026" align="aligncenter" width="460"]<img class="alignnone  wp-image-1026" src="https://pennyhow.files.wordpress.com/2016/01/tuna_subaqueous.gif" alt="An example of a subaqueous calving event at Tunabreen, occurring in the plume area. The section of ice front shown is approximately 350 m, and the iceberg is 40 m wide" width="460" height="460" /> An example of a subaqueous calving event at Tunabreen, occurring in the plume area. The section of ice front shown is approximately 350 m, and the iceberg is 40 m wide[/caption]
