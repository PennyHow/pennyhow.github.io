...
<img src="https://github.com/PennyHow/pennyhow.github.io/blob/master/assets/images/tuna_calving_types_plot_02.jpg?raw=true" alt="Calving events at Tunabreen over a 30-hour period in August 2015" width="800" align="aligncenter" /><br> *Calving events at Tunabreen over a 30-hour period in August 2015, captured using high-resolution time-lapse photography (one photo every three seconds). Calving events are categorised as subaerial  (red), subaqueous (blue), both (green) and unknown (black).*

<img src="https://github.com/PennyHow/pennyhow.github.io/blob/master/assets/images/krone_calving_types_plot_02.jpg?raw=true" alt="Calving events at Kronebreen over a 60-hour period in September 2015" width="800" align="aligncenter" /><br> *Calving events at Kronebreen over a 60-hour period in September 2015, captured using high-resolution time-lapse photography (one photo every three seconds). Calving events are categorised as subaerial (red), subaqueous (blue), both (green) and unknown (black).*
